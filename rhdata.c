...
static struct symbol init_syms[]={
...
#ifdef MSDOS
        { "IHID",       NUMBER, S_IHID,         c_number,       NULL },
        { "ISYS",       NUMBER, S_ISYS,         c_number,       NULL },
        { "IMOD",       NUMBER, S_IMOD,         c_number,       NULL },
        { "IREAD",      NUMBER, S_IREAD,        c_number,       NULL },
        { "IWRITE",     NUMBER, S_IWRITE,       c_number,       NULL },
        { "IEXEC",      NUMBER, S_IEXEC,        c_number,       NULL },
#endif
#ifdef S_ISGID
	...
	{ "prune",	FIELD,	0,		c_prune,	NULL },
        { "days",       NUMBER, 24L*3600L,      c_number,       NULL },
        { "weeks",      NUMBER, 24L*3600L*7L,   c_number,       NULL },
        { "hours",      NUMBER, 3600L,          c_number,       NULL },
